...
/*
This function updates the highest score for the user during the current session. Scores are updated at the end of each game if a highest score has been achieved
*/
function highestScoreUpdater() {
  if (points > highestScore) {
    highestScore = points;
    highestScoreElement.textContent = points;
  }
  return highestScore;
}
...
function setEventListeners() {
  ...
  moles.forEach((mole) => {
    ...
    mole.addEventListener("click", playHitAudio);
  });
  return moles;
}
...
/*
The following two function plays audio when the `Audio on` button is clicked
*/
...
/*
Plays audio when a mole has been hit
*/
...
/*
The following two functions stop audio when the `Stop audio` button is clicked
*/
...
startAudioButton.addEventListener("click", playSong);
endAudioButton.addEventListener("click", stopSong);
